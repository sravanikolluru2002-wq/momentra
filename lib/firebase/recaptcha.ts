...
declare global {
  interface Window {
    ...
    __momentraRecaptchaWidgetId?: number | null;
  }
}
...
export function initializeRecaptchaVerifier(auth: Auth) {
  ...
  window.__momentraRecaptchaWidgetId = window.__momentraRecaptchaWidgetId ?? null;
...
export function resetRecaptchaVerifier() {
  ...
  window.__momentraRecaptchaWidgetId = null;
