...
export type Experience = {
  ...
  title: string;
  category?: string;
  venueType?: "Momentra venue" | "customer home" | "outdoor destination" | "partner venue" | "custom";
  venue: string;
  price: number;
  priceLabel?: string;
  capacity: number;
...
export const OCCASIONS: Occasion[] = [
  ...
  },
  {
    ...
    desc: "Drinks, food, music, and decor",
  ...
  },
  {
    ...
    icon: "B2B",
    label: "Bride-to-Be",
    desc: "Bridal shower celebrations",
    image: "https://images.unsplash.com/photo-1523438885200-e635ba2c371e?w=700&q=80",
  },
  {
    id: "bachelorette",
    icon: "BACH",
    label: "Bachelorette",
    desc: "Premium girls night planning",
  ...
  },
  {
    ...
    icon: "ANN",
    label: "Anniversary",
    desc: "Milestone dinners and surprises",
    image: "https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=700&q=80",
  },
  {
    id: "board-games",
    icon: "GAME",
    label: "Board Games Night",
    desc: "Hosted game nights with snacks",
    image: "https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09?w=700&q=80",
  },
  {
    id: "picnic",
    icon: "DAY",
    label: "Picnic / Day Outing",
    desc: "Outskirts, resorts, and guided day plans",
...
export const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    reviews: 34,
    badge: "NEW",
    description: "A polished at-home birthday setup where Momentra coordinates decor, cake table styling, food support, music, and post-party essentials so your home feels celebration-ready without the planning mess.",
    special: ["Home decor setup", "Cake table styling", "Food coordination", "Music and host add-ons available"],
    reviewList: [
    ...
    addOns: [
      { id: "home-catering", name: "Food", price: 3000, icon: "🍽️" },
      { id: "photographer", name: "Photographer", price: 1500, icon: "📸" },
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 27,
    description: "A refined private dinner experience at home with table styling, food coordination, warm lighting, and optional chef or food support for close friends, family, or intimate celebrations.",
    ...
    addOns: [
      { id: "premium-catering", name: "Premium Food", price: 4500, icon: "🍽️" },
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 31,
    description: "A terrace-friendly house party setup with decor, lighting, music, food coordination, and optional games or host support for a lively private gathering at home.",
    ...
    addOns: [
      ...
      { id: "catering", name: "Food", price: 4000, icon: "🍽️" },
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 22,
    description: "A relaxed house-party format for friends gatherings and game nights, with cozy decor, snack and food coordination, music support, and an optional host or games coordinator to keep the evening moving.",
    ...
    addOns: [
      ...
      { id: "catering", name: "Food", price: 3500, icon: "🍽️" },
      { id: "dj-music", name: "DJ or Music Setup", price: 3000, icon: "🎵" },
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 18,
    description: "A premium villa or poolside house party setup for private celebrations, with outdoor styling, food coordination, photographer options, music setup, and end-to-end vendor execution.",
    ...
    addOns: [
      ...
      { id: "premium-catering", name: "Premium Food", price: 6000, icon: "🍽️" },
  ...
  {
    id: "signature-cocktail-party",
    occasionId: "cocktail-party",
    category: "Cocktail Party",
    venueType: "partner venue",
    title: "Signature Cocktail Party",
    venue: "Partner Lounge, Vizag",
    price: 11999,
    priceLabel: "Custom quote from INR 11,999",
    capacity: 18,
    minimumGuests: 12,
    duration: "3-4 hours",
    city: "Visakhapatnam",
    ...
    reviews: 32,
    badge: "NEW",
    description: "A lounge-style cocktail party package where Momentra coordinates decor, food, bar setup, music, and party flow for birthdays, reunions, team socials, and private celebrations.",
    special: ["Decor package and party layout", "Food or curated buffet coordination", "Bar and drinks setup support", "Music, dance floor, host, and photography add-ons"],
    requirements: ["Decor package", "Food / curated buffet", "Bar / drinks setup", "Dance floor", "DJ / music", "Live band optional", "Photographer optional", "Host optional"],
    image: "https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=900&q=80",
    inclusions: ["Partner venue coordination", "Decor planning", "Food flow support", "Music-ready setup"],
    addOns: [
      { id: "bar-setup", name: "Bar Setup", price: 4500, icon: "BAR" },
      { id: "dj-music", name: "DJ / Music", price: 3500, icon: "DJ" },
      { id: "live-band", name: "Live Band", price: 7000, icon: "LIVE" },
      { id: "photographer", name: "Photographer", price: 1800, icon: "PHOTO" },
    ],
  },
  {
    id: "bridal-shower-theme",
    occasionId: "bridal-shower",
    category: "Bride-to-Be",
    venueType: "Momentra venue",
    title: "Bride-to-Be Theme Shower",
    venue: "Momentra venue or home setup, Vizag",
    price: 9999,
    priceLabel: "Custom quote from INR 9,999",
    capacity: 14,
    minimumGuests: 8,
    duration: "3 hours",
    city: "Visakhapatnam",
    rating: 4.9,
    reviews: 26,
    description: "A polished bridal shower setup with theme decor, backdrop, music, games, soft drinks, and optional cake, makeup, props, and photographer support.",
    special: ["Theme decor and backdrop", "Games and music coordination", "Food, soft drinks, and welcome drink planning", "Cake, makeup artist, and personalized props available"],
    requirements: ["Venue", "Theme decor", "Music", "Games", "Stage / backdrop", "Food and soft drinks", "Welcome drinks", "Cake optional", "Photographer optional", "Makeup artist optional", "Personalized props optional"],
    image: "https://images.unsplash.com/photo-1523438885200-e635ba2c371e?w=900&q=80",
    inclusions: ["Theme decor", "Backdrop setup", "Games plan", "Welcome drinks"],
    addOns: [
      { id: "cake", name: "Cake", price: 900, icon: "CAKE" },
      { id: "makeup", name: "Makeup Artist", price: 3500, icon: "MUA" },
      { id: "props", name: "Personalized Props", price: 1600, icon: "PROP" },
      { id: "photographer", name: "Photographer", price: 1800, icon: "PHOTO" },
    ],
  },
  {
    id: "bachelorette-night",
    occasionId: "bachelorette",
    category: "Bachelorette",
    venueType: "partner venue",
    title: "Bachelorette Party Night",
    venue: "Private lounge or villa, Vizag",
    price: 14999,
    priceLabel: "Custom quote from INR 14,999",
    capacity: 16,
    minimumGuests: 8,
    duration: "4 hours",
    city: "Visakhapatnam",
    rating: 4.8,
    reviews: 21,
    description: "A premium girls night package with venue coordination, theme decor, food and drinks, music, dance floor planning, games, and optional DJ, host, and photography.",
    special: ["Theme decor for the bride squad", "Food, drinks, games, and music flow", "Dance floor and DJ support available", "Host and photographer add-ons for a smoother night"],
    requirements: ["Venue", "Theme decor", "Music", "Games", "Food and drinks", "Dance floor", "DJ optional", "Photographer optional", "Host optional"],
    image: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=900&q=80",
    inclusions: ["Venue shortlisting", "Theme decor", "Games plan", "Food and drinks coordination"],
    addOns: [
      { id: "dj", name: "DJ", price: 4000, icon: "DJ" },
      { id: "host", name: "Party Host", price: 2500, icon: "HOST" },
      { id: "photo", name: "Photographer", price: 1800, icon: "PHOTO" },
    ],
  },
  {
    id: "anniversary-dinner-setup",
    ...
    price: 6999,
    priceLabel: "Custom quote from INR 6,999",
    capacity: 6,
    minimumGuests: 2,
    duration: "2-3 hours",
    city: "Visakhapatnam",
    rating: 4.9,
    reviews: 44,
    description: "A warm anniversary experience with food, decor, music, optional screen/projector, cake, host, photographer, and custom theme support for couples or family-led milestones.",
    special: ["Food, decor, and music handled together", "Custom theme and cake support", "Projector or screen add-on available", "Works at home, private dining, or partner venue"],
    requirements: ["Food", "Decor", "Music", "Projector/screen optional", "Cake complimentary or add-on", "Host optional", "Photographer optional", "Custom theme optional"],
    image: "https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=900&q=80",
    inclusions: ["Anniversary decor", "Food coordination", "Music setup", "Cake table styling"],
    addOns: [
      { id: "projector", name: "Projector / Screen", price: 2200, icon: "AV" },
      { id: "premium-cake", name: "Premium Cake", price: 1200, icon: "CAKE" },
      { id: "photographer", name: "Photographer", price: 1800, icon: "PHOTO" },
    ],
  },
  {
    id: "board-games-night",
    occasionId: "board-games",
    category: "Board Games Night",
    venueType: "customer home",
    title: "Hosted Board Games Night",
    venue: "At your home or cafe venue, Vizag",
    price: 3999,
    priceLabel: "Custom quote from INR 3,999",
    capacity: 10,
    minimumGuests: 6,
    duration: "3 hours",
    city: "Visakhapatnam",
    rating: 4.7,
    reviews: 19,
    description: "A relaxed games night with board games kit, snacks, beverages, music, and optional game coordinator, food, and venue setup for friends or team circles.",
    special: ["Board games kit and layout", "Snacks, beverages, and music support", "Game coordinator optional", "Works at home, cafe, or partner venue"],
    requirements: ["Venue or home setup", "Board games kit", "Snacks", "Beverages", "Music", "Host/game coordinator optional", "Food optional"],
    image: "https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09?w=900&q=80",
    inclusions: ["Board games kit", "Snack table styling", "Beverage planning", "Music-ready setup"],
    addOns: [
      { id: "game-host", name: "Game Coordinator", price: 2200, icon: "HOST" },
      { id: "food", name: "Food Package", price: 3200, icon: "FOOD" },
      { id: "venue", name: "Cafe Venue", price: 4500, icon: "VENUE" },
    ],
  },
  {
    id: "guided-day-picnic",
    occasionId: "picnic",
    category: "Picnic / Day Outing",
    venueType: "outdoor destination",
    title: "Guided Picnic & Day Outing",
    venue: "Vizag outskirts, Araku, or resort destination",
    price: 8999,
    priceLabel: "Custom quote from INR 8,999",
    capacity: 12,
    minimumGuests: 6,
    duration: "Day outing or overnight",
    city: "Visakhapatnam",
    rating: 4.8,
    reviews: 24,
    description: "A destination-style outing where Momentra coordinates the venue, guide, food, games, bonfire options, and transport support for families, friends, and teams.",
    special: ["Destination and guide coordination", "Day outing or overnight plan", "Activities, board games, bonfire, and food", "Transport support available"],
    requirements: ["Venue/destination", "Guide provided", "Day outing or overnight stay", "Fun activities", "Board games", "Bonfire", "Food", "Transportation optional"],
    image: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=900&q=80",
    inclusions: ["Destination shortlisting", "Guide coordination", "Food plan", "Activities checklist"],
    addOns: [
      { id: "transport", name: "Transportation", price: 6500, icon: "BUS" },
      { id: "bonfire", name: "Bonfire", price: 2500, icon: "FIRE" },
      { id: "overnight", name: "Overnight Stay", price: 9000, icon: "STAY" },
    ],
  },
  {
    id: "custom-setup",
