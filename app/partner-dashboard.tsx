...
const styles = StyleSheet.create({
  ...
  logoIcon: { alignItems: "center", borderRadius: 9, height: 32, justifyContent: "center", width: 32 },
  logoIconText: { color: "#FFFFFF", fontSize: 14, fontWeight: "800" },
  logoTitle: { color: "#F2E8D9", fontFamily: "serif", fontSize: 18, fontStyle: "italic" },
