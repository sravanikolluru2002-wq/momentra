...
const EXPERIENCES: ExploreExperience[] = [
  {
    id: 1,
    detailId: "date-terrace",
    cat: "datenight",
    title: "Skyline Romance",
    venue: "Rooftop Lounge • Vizag",
    desc: "Candlelight dinner with panoramic sea view and personalised floral setup.",
    price: 4999,
    ppl: 2,
    rating: 4.9,
    tag: "bestseller",
    img: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=500&q=85",
  },
  {
    id: 2,
    detailId: "birthday-terrace",
    cat: "birthday",
    title: "Golden Birthday Bash",
    venue: "Urban Garden • Vizag",
    desc: "Balloon arch, custom cake, fairy lights and gorgeous ambiance.",
    price: 6999,
    ppl: 10,
    rating: 4.7,
    tag: "",
    img: "https://images.unsplash.com/photo-1519671282429-b44b4a72b065?w=500&q=85",
  },
  {
    id: 3,
    detailId: "birthday-poolside",
    cat: "banquet",
    title: "Royal Banquet Experience",
    venue: "The Grand Palace • Vizag",
    desc: "Luxury banquet hall for weddings, receptions and grand celebrations.",
    price: 15999,
    ppl: 50,
    rating: 4.6,
    tag: "new",
    img: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=500&q=85",
  },
  {
    id: 4,
    detailId: "party-hall",
    ...
    venue: "Beachside Bliss • Vizag",
    desc: "Bonfire, live music, BBQ and chill vibes with your favourite people.",
    price: 3499,
    ppl: 4,
    rating: 4.5,
    tag: "trending",
    img: "https://images.unsplash.com/photo-1533777857889-4be7c70b33f7?w=500&q=85",
  },
  {
    id: 5,
    detailId: "kitty-brunch",
    cat: "kitty",
    title: "Luxury Kitty Brunch",
    venue: "Novotel • Vizag",
    desc: "Private dining, brunch buffet, premium wine and curated decor.",
    price: 2499,
    ppl: 10,
    rating: 4.8,
    tag: "bestseller",
  ...
  {
    id: 6,
    detailId: "corporate-dinner",
    cat: "corporate",
    title: "Corporate Dinner Night",
    venue: "Marriott • Vizag",
    desc: "Gourmet dinner, AV setup, private hall and professional service.",
    price: 3499,
    ppl: 15,
    rating: 4.6,
    tag: "new",
    img: "https://images.unsplash.com/photo-1551818255-e6e10975bc17?w=500&q=85",
  },
  {
    id: 7,
    detailId: "date-beach",
    ...
    desc: "Exclusive beachside setup, 4-course meal, candles and roses.",
    price: 5999,
    ppl: 2,
    rating: 4.8,
    tag: "trending",
    img: "https://images.unsplash.com/photo-1536489885071-8a39f1b3c6a6?w=500&q=85",
  },
  {
    id: 8,
    detailId: "birthday-terrace",
    cat: "birthday",
    title: "Terrace Birthday Bash",
    venue: "Rooftop Suite • Rushikonda",
    desc: "Fairy lights, birthday cake, reserved terrace and personalised decor.",
    price: 6999,
    ppl: 6,
    rating: 4.8,
    tag: "bestseller",
  ...
  {
    id: 9,
    detailId: "custom-setup",
    cat: "banquet",
    title: "Garden Banquet Evening",
    venue: "Palm Resort • Vizag",
    desc: "Open-air garden banquet with premium catering and floral arrangements.",
    price: 12999,
    ppl: 40,
    rating: 4.5,
    tag: "",
  ...
  },
  {
    ...
    desc: "Exclusive hall, DJ setup, curated buffet and premium decor package.",
    price: 9999,
    ppl: 20,
    rating: 4.7,
    tag: "trending",
    img: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?w=500&q=85",
  },
  {
    id: 11,
    detailId: "custom-setup",
    cat: "cafe",
    title: "Artisan Cafe Celebration",
    venue: "Brew House • Vizag",
    desc: "Cozy cafe table styling, desserts, mocktails and warm ambient decor.",
    price: 2999,
    ppl: 4,
    rating: 4.7,
    tag: "new",
    img: "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=500&q=85",
  },
  {
    id: 12,
    detailId: "date-terrace",
    cat: "cafe",
    title: "Private Coffee Date",
    venue: "Roastery Corner • Vizag",
    desc: "Reserved cafe corner with floral accents, coffee pairings and dessert.",
    price: 1999,
    ppl: 2,
    rating: 4.6,
    tag: "trending",
    img: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=500&q=85",
  },
];
